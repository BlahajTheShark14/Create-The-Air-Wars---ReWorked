...
public class C25Entity extends AbstractArrow implements ItemSupplier {
	public static final ItemStack PROJECTILE_ITEM = new ItemStack(CreateTheAirWarsModBlocks.OZM_72.get());

	public C25Entity(PlayMessages.SpawnEntity packet, Level world) {
		super(CreateTheAirWarsModEntities.C_25.get(), world);
	}
	...
	public void onHitBlock(BlockHitResult blockHitResult) {
		...
		C25KoghdaSnariadPopadaietVBlokProcedure.execute(this.level(), blockHitResult.getBlockPos().getX(), blockHitResult.getBlockPos().getY(), blockHitResult.getBlockPos().getZ());
	}
