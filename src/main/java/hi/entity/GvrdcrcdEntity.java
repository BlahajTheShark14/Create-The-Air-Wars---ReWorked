...
public class GvrdcrcdEntity extends AbstractArrow implements ItemSupplier {
	public static final ItemStack PROJECTILE_ITEM = new ItemStack(CreateTheAirWarsModBlocks.GTDFDGF.get());

	public GvrdcrcdEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(CreateTheAirWarsModEntities.GVRDCRCD.get(), world);
	}
