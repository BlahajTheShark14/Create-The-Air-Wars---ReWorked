...
public class Rim7actvbultEntity extends AbstractArrow implements ItemSupplier {
	public static final ItemStack PROJECTILE_ITEM = new ItemStack(CreateTheAirWarsModBlocks.RIM_7ACTIVE.get());

	public Rim7actvbultEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(CreateTheAirWarsModEntities.RIM_7ACTVBULT.get(), world);
	}
