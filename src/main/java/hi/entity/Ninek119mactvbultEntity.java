...
public class Ninek119mactvbultEntity extends AbstractArrow implements ItemSupplier {
	public static final ItemStack PROJECTILE_ITEM = new ItemStack(CreateTheAirWarsModBlocks.NINEK_119MACTV.get());

	public Ninek119mactvbultEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(CreateTheAirWarsModEntities.NINEK_119MACTVBULT.get(), world);
	}
